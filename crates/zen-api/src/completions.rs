...
use zen_core::{
    CompletionChunkResponse, CompletionResponse, Constraint, zentrix, NormalRequest, Request,
...
///
/// ```no_run
/// use zen_api::completions::CompletionOnChunkCallback;
///
...
///
/// ```no_run
/// use zen_api::completions::CompletionOnDoneCallback;
///
...
pub fn match_responses(state: SharedZentrixState, response: Response) -> CompletionResponder {
    match response {
        Response::InternalError(e) => {
