...
fn gather_kv_cache_for_layout(
    ...
    match AttentionBackendKind::from_cache(key_cache, value_cache) {
        ...
        AttentionBackendKind::Standard => zen_kernels_paged::gather_kv_cache(
            key_cache,
            value_cache,
            k_scale,
            v_scale,
...
impl PagedAttention {
    ...
    fn run_flash_attention_paged_prefill(
        ...
        let out = zen_kernels_flash::flash_attn_varlen_paged_windowed(
            &q_flat,
            &k_paged,
            &v_paged,
            &cu_q,
