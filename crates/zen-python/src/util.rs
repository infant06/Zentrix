...
use zen_core::{
    AudioInput, ChatCompletionResponse, CompletionResponse, zentrix, Request, Response,
...
impl From<zen_core::ZenError> for PyApiErr {
    fn from(value: zen_core::ZenError) -> Self {
        Self::from(value.to_string())
    }
}
...
pub(crate) fn send_request_with_optional_stream(
    ...
    zentrix::maybe_log_request(runner.clone(), debug_repr);
    let sender = runner
