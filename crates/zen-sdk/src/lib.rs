//! # zentrix, Blazing-Fast LLM Inference in Rust
//!
//! The Rust SDK for [Zentrix](https://github.com/EricLBuehler/Zentrix), a high-performance
//! LLM inference engine supporting text, multimodal, speech, image generation, and embedding models.
//!
//! ## Quick Start
//!
//! ```no_run
//! use zen_sdk::{IsqBits, ModelBuilder, TextMessages, TextMessageRole};
//!
//! #[tokio::main]
//! async fn main() -> zen_sdk::error::Result<()> {
...
//!
//! ```no_run
//! use zen_sdk::blocking::BlockingModel;
//! use zen_sdk::{IsqBits, ModelBuilder};
//!
//! fn main() -> zen_sdk::error::Result<()> {
...
pub use zen_core::{SerializedSession, SerializedVideo};
...
/// Low-level types and internals re-exported from `zen_core`.
///
...
// ========== Request Types ==========
pub use zen_core::{Constraint, LlguidanceGrammar, MessageContent, NormalRequest, Request};

// ========== Sampling ==========
pub use zen_core::{DrySamplingParams, ModelGenerationDefaults, SamplingParams, StopTokens};
...
// ========== Config Types ==========
pub use zen_core::{
    DefaultSchedulerMethod, IsqType, MemoryGpuConfig, ZenConfig, ModelDType,
    PagedAttentionConfig, PagedCacheType, SchedulerConfig, WebSearchOptions,
};

// ========== Audio Types ==========
pub use zen_core::AudioInput;

// ========== Video Types ==========
pub use zen_core::VideoInput;

// ========== Custom Logits ==========
pub use zen_core::CustomLogitsProcessor;

// ========== Model Category ==========
pub use zen_core::ModelCategory;

// ========== Search Types ==========
pub use zen_core::{SearchEmbeddingModel, SearchFunctionParameters};

// ========== Speech Types ==========
pub use zen_core::{speech_utils, SpeechLoaderType};

// ========== AnyMoe Types ==========
pub use zen_core::{AnyMoeConfig, AnyMoeExpertType};
...
// ========== Speculative Types ==========
pub use zen_core::{MtpConfig, SpeculativeConfig};

// ========== Device Mapping ==========
pub use zen_core::{AutoDeviceMapParams, DeviceMapSetting};

// ========== Topology ==========
pub use zen_core::{LayerTopology, Topology};

// ========== Loader Types ==========
pub use zen_core::{MultimodalLoaderType, NormalLoaderType};

// ========== Token Source ==========
pub use zen_core::TokenSource;

// ========== Engine (Advanced) ==========
pub use zen_core::{IntervalLogger, zentrix, RequestMessage, ResponseOk};

// ========== Utilities ==========
pub use zen_core::{initialize_logging, paged_attn_supported, parse_isq_value};

// ========== llguidance ==========
pub use zen_core::llguidance;

// Re-export the tool proc macro for ergonomic tool definition
pub use zen_macros::tool;
