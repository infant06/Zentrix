...
use zen_core::{DrySamplingParams, zentrix, StopTokens as InternalStopTokens};

use crate::{openai::StopTokens, types::SharedZentrixState, util::sanitize_error_message};
...
pub(crate) fn handle_completion_error<R, S>(
    ...
    zentrix::maybe_log_error(state, &*full_error);
...
/// Helper function to convert from the OpenAI stop tokens to the Zentrix
