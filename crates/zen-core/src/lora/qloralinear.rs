...
impl LinearLayerLike for QLoraLinear {
    ...
    fn weight(&self) -> &Tensor {
        // QLoRA wraps a quantized layer; direct weight access is not supported
        panic!("QLoraLinear does not support direct weight access; use dequantize via the underlying quant layer")
    }
    fn lora_forward(
        &self,
        input: &Tensor,
