...
pub struct ChatCompletionRequest {
    ...
    pub(crate) code_execution_permission: Option<zen_core::CodeExecutionPermission>,
    pub(crate) agent_permission: Option<zen_core::AgentPermission>,
