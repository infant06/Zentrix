//! Proc macros for ergonomic tool definition in Zentrix
//!
//! This crate provides the `#[tool]` attribute macro for defining tools
//! that can be used with the Zentrix agentic loop.
//!
//! # Example
//!
//! ```ignore
...
/// used with the Zentrix agentic loop. It generates:
///
...
fn generate_tool_impl(args: ToolArgs, input_fn: ItemFn) -> syn::Result<TokenStream2> {
    ...
    let output = if is_async {
        ...
        quote! {
            ...
            #fn_vis fn #tool_fn_name() -> zen_sdk::Tool {
                ...
                zen_sdk::Tool {
                    tp: zen_sdk::ToolType::Function,
                    function: zen_sdk::Function {
            ...
            #fn_vis fn #callback_fn_name() -> std::sync::Arc<zen_sdk::AsyncToolCallback> {
                std::sync::Arc::new(|called: zen_sdk::CalledFunction| {
                    Box::pin(async move {
            ...
            #fn_vis fn #combined_fn_name() -> (zen_sdk::Tool, zen_sdk::ToolCallbackType) {
                (#tool_fn_name(), zen_sdk::ToolCallbackType::Async(#callback_fn_name()))
            }
        }
    } else {
        ...
        quote! {
            ...
            #fn_vis fn #callback_fn_name() -> std::sync::Arc<zen_sdk::ToolCallback> {
                std::sync::Arc::new(|called: &zen_sdk::CalledFunction, _ctx: &zen_sdk::ToolCallContext| {
                    let args: #args_struct_name = serde_json::from_str(&called.arguments)
                        .map_err(|e| anyhow::anyhow!("Failed to parse tool arguments: {}", e))?;
            ...
            /// Returns both the Tool definition and callback as a tuple
            #fn_vis fn #combined_fn_name() -> (zen_sdk::Tool, zen_sdk::ToolCallbackType) {
                (#tool_fn_name(), zen_sdk::ToolCallbackType::Sync(#callback_fn_name()))
            }
        }
    };
