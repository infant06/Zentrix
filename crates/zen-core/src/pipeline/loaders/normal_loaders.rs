...
use zen_kernels_quant::log::once_log_debug;

use indicatif::MultiProgress;
use zen_kernels_quant::ShardedVarBuilder;
...
pub trait NormalModelLoader: IsqModelLoader + Send + Sync + DeviceMappedModelLoader {
    ...
    fn load_flexload(
        &self,
        _paths: &Box<dyn crate::pipeline::ModelPaths>,
        _config: &str,
        _vb: ShardedVarBuilder,
        _normal_loading_metadata: NormalLoadingMetadata,
        _attention_mechanism: AttentionImplementation,
    ) -> Result<Box<dyn NormalModel + Send + Sync>> {
        anyhow::bail!("FlexLoad is not supported for this model type")
    }
    #[allow(clippy::too_many_arguments)]
    fn load_xlora(
        &self,
...
impl NormalModelLoader for AutoNormalLoader {
    ...
    fn load_flexload(
        ...
        Self::get_loader(config)?.load_flexload(paths, config, vb, normal_loading_metadata, attention_mechanism)
    }
    fn load_xlora(
        &self,
        config: &str,
...
impl NormalModelLoader for MistralLoader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::mistral::Config = serde_json::from_str(config)?;
        let base_model = models::mistral::Model::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::mistral::FlexMistralRunner::new(
            base_model,
            cfg.clone(),
            paths,
...
///
/// [`NormalLoader`]: https://docs.rs/zentrix/latest/zentrix/struct.NormalLoader.html
...
impl NormalModelLoader for GemmaLoader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::gemma::Config = serde_json::from_str(config)?;
        let base_model = models::gemma::Model::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::gemma::FlexGemmaRunner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
...
impl NormalModelLoader for LlamaLoader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::llama::Config = serde_json::from_str(config)?;
        let base_model = models::llama::Llama::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::llama::FlexLlamaRunner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
...
impl NormalModelLoader for Phi2Loader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::phi2::Config = serde_json::from_str(config)?;
        let base_model = models::phi2::Model::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::phi2::FlexPhi2Runner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
...
impl NormalModelLoader for Phi3Loader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::phi3::Config = serde_json::from_str(config)?;
        let base_model = models::phi3::Model::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::phi3::FlexPhi3Runner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
...
impl NormalModelLoader for Qwen2Loader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::qwen2::Config = serde_json::from_str(config)?;
        let base_model = models::qwen2::Model::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::qwen2::FlexQwen2Runner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
    ...
    fn load_xlora(
        ...
        anyhow::bail!("X-LoRA is not supported for this model type")
    }
    fn is_gptx(&self, _: &str) -> Result<bool> {
        Ok(true)
    }
...
impl NormalModelLoader for DeepSeekV2Loader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::deepseek2::DeepSeekV2Config = serde_json::from_str(config)?;
        let base_model = models::deepseek2::DeepSeekV2::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::deepseek2::FlexDeepSeekV2Runner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
...
impl NormalModelLoader for DeepSeekV3Loader {
    ...
    fn load_flexload(
        ...
        let cfg: crate::models::deepseek3::DeepSeekV3Config = serde_json::from_str(config)?;
        let base_model = models::deepseek3::DeepSeekV3::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
        ...
        Ok(Box::new(crate::flexload::runners::deepseek3::FlexDeepSeekV3Runner::new(
            base_model,
            cfg.clone(),
            paths,
            cfg.num_hidden_layers,
