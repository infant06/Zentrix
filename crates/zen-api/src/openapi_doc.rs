...
/// The Zentrix server router will include these by default, but if you're
/// including the Zentrix server core into another project, you can generate the
/// OpenAPI docs separately to merge with the other project OpenAPI docs.
///
/// ### Arguments
/// * `base_path` - the base path of the Zentrix server instance (in case the Zentrix server is being included in another axum project)
///
/// ### Example
/// ```ignore
/// // MyApp
...
/// use zen_api::openapi_doc::get_openapi_doc;
///
/// #[derive(OpenApi)]
/// #[openapi(
...
pub fn get_openapi_doc(base_path: Option<&str>) -> utoipa::openapi::OpenApi {
    ...
    #[openapi(
        ...
        tags(
            (name = "Zentrix", description = "Zentrix API")
        ),
        info(
            title = "Zentrix",
            license(
