...
impl FullAttention {
    ...
    fn load(
        ...
        Ok(Self {
            ...
            paged_attn,
            sdpa_params: SdpaParams {
                n_kv_groups: zen_kernels_quant::compute_n_kv_groups(num_kv_heads, num_heads, comm)?,
                softcap: None,
...
impl Model {
    pub fn new(
        ...
        if !cfg.mlp_only_layers.is_empty() {
            candle_core::bail!("Qwen3Next `mlp_only_layers` is not implemented yet in Zentrix.");
        }
