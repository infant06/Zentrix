...
use zen_core::*;
use zen_core::{SearchCallback, Tool, ToolCallback, ToolCallbackKind};
...
pub struct ModelBuilder {
    ...
    pub(crate) code_exec_config: Option<zen_core::CodeExecutionConfig>,
}
...
impl ModelBuilder {
    ...
    pub fn with_code_execution(mut self, config: zen_core::CodeExecutionConfig) -> Self {
