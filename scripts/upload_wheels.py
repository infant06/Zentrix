#!/usr/bin/env python3
"""
Upload script for zentrix Python wheels to PyPI.
...
WHEEL_TO_PYPI = {
    "zentrix": "zentrix",
    "mistralrs_cuda": "zentrix-cuda",
    "mistralrs_metal": "zentrix-metal",
    "mistralrs_accelerate": "zentrix-accelerate",
    "mistralrs_mkl": "zentrix-mkl",
}
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Upload zentrix wheels to PyPI",
...
Examples:
  ...
  python scripts/upload_wheels.py ./wheels -p zentrix-cuda
        """,
    )
