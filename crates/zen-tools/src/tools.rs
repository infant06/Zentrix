use zen_protocol::{Function, Tool, ToolType};
use zen_isolate::{EffectiveProtection, NetworkMode};
use serde_json::json;
use std::collections::HashMap;

use crate::InputModality;

pub const EXECUTE_PYTHON_TOOL_NAME: &str = "zenllm_execute_python";
pub const RESET_SESSION_TOOL_NAME: &str = "zenllm_reset_python_session";
pub const READ_FILE_TOOL_NAME: &str = "zenllm_read_file";
pub const LIST_FILES_TOOL_NAME: &str = "zenllm_list_files";
