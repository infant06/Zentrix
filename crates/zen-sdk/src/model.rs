...
pub use zen_core::{AddModelConfig, ModelStatus, Pipeline, SchedulerConfig};
...
impl Model {
    ...
    pub fn config(&self) -> crate::error::Result<ZenConfig> {
    ...
    /// Get the underlying zentrix instance.
    pub fn inner(&self) -> &zentrix {
        &self.runner
    }
    ...
    pub fn export_session(
        ...
        model_id: Option<&str>,
        session_id: &str,
    ) -> crate::error::Result<Option<zen_core::SerializedSession>> {
    ...
    pub fn import_session(
        ...
        session: zen_core::SerializedSession,
    ) -> crate::error::Result<()> {
        Ok(self
            .runner
    ...
    pub fn list_mcp_tools(
        ...
        self.runner
            ...
            .map_err(|e| crate::error::Error::from(zen_core::ZenError::Other(e)))
    }
}
