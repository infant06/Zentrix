...
impl QuantMethod for GptqLayer {
    ...
    fn dequantize_w(&self) -> Result<Tensor> {
        candle_core::bail!("GPTQ CPU stub: dequantize_w is not supported without CUDA")
    }

    fn forward_raw(&self, _a: &Tensor) -> Result<Tensor> {
        candle_core::bail!("GPTQ CPU stub: forward_raw requires CUDA")
    }
    ...
    fn add_delta_w(&self, _delta: &Tensor) -> Result<Arc<dyn QuantMethod>> {
        candle_core::bail!("GPTQ CPU stub: add_delta_w requires CUDA")
    }
    ...
    fn apply_isq(
        ...
        candle_core::bail!("GPTQ CPU stub: apply_isq requires CUDA")
    }
}
