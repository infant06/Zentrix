...
use zen_core::{AutoDeviceMapParams, IsqOrganization, ModelDType, NormalLoaderType};
...
pub struct QuantizationOptions {
    ...
    /// names prefer a prebuilt UQFF from `zentrix-community/<model>-UQFF`, then
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, clap::ValueEnum, Default, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "kebab-case")]
...
impl From<RuntimeModeArg> for zen_core::RuntimeMode {
    fn from(value: RuntimeModeArg) -> Self {
        match value {
            RuntimeModeArg::Auto => zen_core::RuntimeMode::Auto,
            RuntimeModeArg::GpuOnly => zen_core::RuntimeMode::GpuOnly,
            RuntimeModeArg::CpuOnly => zen_core::RuntimeMode::CpuOnly,
            RuntimeModeArg::PartialOffload => zen_core::RuntimeMode::PartialOffload,
            RuntimeModeArg::FlexLoad => zen_core::RuntimeMode::FlexLoad,
            RuntimeModeArg::MultiGpu => zen_core::RuntimeMode::MultiGpu,
        }
    }
}
