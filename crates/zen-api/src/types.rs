//! ## Custom types used in Zentrix server core.

use std::sync::Arc;

use axum::extract::State;
use zen_core::{zentrix, Pipeline};

/// This is the underlying instance of Zentrix.
pub type SharedZentrixState = Arc<zentrix>;

/// This is the `SharedZentrixState` that has been extracted for an axum handler.
pub type ExtractedZentrixState = State<SharedZentrixState>;
...
///
/// ```no_run
/// use zen_core::ChatCompletionChunkResponse;
/// use zen_api::types::OnChunkCallback;
///
...
/// ```no_run
/// use zen_core::ChatCompletionChunkResponse;
/// use zen_api::types::OnDoneCallback;
///
