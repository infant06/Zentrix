...
pub const UNLOAD_MODEL_ROUTE: RouteInfo =
    RouteInfo::new("/v1/models/unload", "POST", RouteKind::Zentrix);
pub const RELOAD_MODEL_ROUTE: RouteInfo =
    RouteInfo::new("/v1/models/reload", "POST", RouteKind::Zentrix);
pub const MODEL_STATUS_ROUTE: RouteInfo =
    RouteInfo::new("/v1/models/status", "POST", RouteKind::Zentrix);
pub const TUNE_MODEL_ROUTE: RouteInfo =
    RouteInfo::new("/v1/models/tune", "POST", RouteKind::Zentrix);
pub const SYSTEM_INFO_ROUTE: RouteInfo =
    RouteInfo::new("/v1/system/info", "GET", RouteKind::Zentrix);
pub const SYSTEM_DOCTOR_ROUTE: RouteInfo =
    RouteInfo::new("/v1/system/doctor", "POST", RouteKind::Zentrix);
pub const DIAGNOSTICS_ROUTE: RouteInfo =
    RouteInfo::new("/diagnostics", "GET", RouteKind::Zentrix);
pub const HEALTH_ROUTE: RouteInfo = RouteInfo::new("/health", "GET", RouteKind::Zentrix);
pub const ROOT_ROUTE: RouteInfo = RouteInfo::new("/", "GET", RouteKind::Zentrix);
pub const RE_ISQ_ROUTE: RouteInfo = RouteInfo::new("/re_isq", "POST", RouteKind::Zentrix);
...
pub const VECTOR_SEARCH_ROUTE: RouteInfo =
    RouteInfo::new("/v1/zentrix/vector/search", "POST", RouteKind::Zentrix);
...
pub const ZENTRIX_API_ROUTES: &[RouteInfo] = &[
    ROOT_ROUTE,
    HEALTH_ROUTE,
    MODELS_ROUTE,
    UNLOAD_MODEL_ROUTE,
...
pub const ZENTRIX_SWAGGER_ROUTES: &[RouteInfo] = &[
