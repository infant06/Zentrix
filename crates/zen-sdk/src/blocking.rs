//! Synchronous (blocking) wrappers for the zentrix SDK.
//!
...
//! use zen_sdk::{IsqBits, TextModelBuilder, TextMessages, TextMessageRole};
//!
...
/// ```no_run
/// # use zen_sdk::blocking::{BlockingModel, BlockingStream};
/// # use zen_sdk::*;
