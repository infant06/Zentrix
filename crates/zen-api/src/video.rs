...
//!
//! See <https://ericlbuehler.github.io/Zentrix/guides/models/video-setup/> for full details.

use anyhow::{bail, Context, Result};
use image::codecs::gif::GifDecoder;
use image::{AnimationDecoder, DynamicImage};
use zen_core::{sample_frame_indices, VideoInput};
use std::io::Cursor;
use std::path::Path;
use tokio::{
    fs::{self, File},
...
FFmpeg is required for video input (non-GIF formats). Install it:
  ...
  - macOS:   brew install ffmpeg
  - Windows: https://ffmpeg.org/download.html
See https://ericlbuehler.github.io/Zentrix/guides/models/video-setup/ for details.";
...
async fn decode_video_ffmpeg(
    ...
    // Write to temp file
    let tmp_dir = std::env::temp_dir().join("zentrix_video");
