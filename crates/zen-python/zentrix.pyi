...
def detect_hardware() -> str:
    """Detects available CPU, RAM, and GPU/Accelerators, returning a JSON string."""
    ...

@dataclass
class ChatCompletionRequest:
    """
    A ChatCompletionRequest represents a request sent to the Zentrix runtime. It encodes information
    ...
    See [agent permissions](/Zentrix/guides/agents/agentic-runtime/#agent-permissions)
...
class CompletionRequest:
    """
    A CompletionRequest represents a request sent to the Zentrix runtime. It encodes information
    about input data, sampling, and how to return the response.
    """
...
class Runner:
    def __init__(
        ...
        tool_callbacks: dict[str, Callable[[str, dict], str]] | None = None,
    ...
    def send_chat_completion_request(
        ...
        """
        Send a chat completion request to the Zentrix runtime, returning the response object or a generator
        over chunk objects.
    ...
    def send_completion_request(
        ...
        """
        Send a completion request to the Zentrix runtime, returning the response object.
