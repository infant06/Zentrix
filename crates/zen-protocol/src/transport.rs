...
///
/// ```rust,no_run
/// use zen_protocol::transport::{HttpTransport, McpTransport};
/// use std::collections::HashMap;
///
/// #[tokio::main]
...
impl HttpTransport {
    ...
    ///
    /// ```rust,no_run
    /// use zen_protocol::transport::HttpTransport;
    /// use std::collections::HashMap;
    ///
...
///
/// ```rust,no_run
/// use zen_protocol::transport::{ProcessTransport, McpTransport};
/// use std::collections::HashMap;
///
/// #[tokio::main]
/// async fn main() -> anyhow::Result<()> {
...
impl ProcessTransport {
    ...
    ///
    /// ```rust,no_run
    /// use zen_protocol::transport::ProcessTransport;
    /// use std::collections::HashMap;
    ///
    /// #[tokio::main]
    /// async fn main() -> anyhow::Result<()> {
...
///
/// ```rust,no_run
/// use zen_protocol::transport::{WebSocketTransport, McpTransport};
/// use std::collections::HashMap;
///
/// #[tokio::main]
/// async fn main() -> anyhow::Result<()> {
...
impl WebSocketTransport {
    ...
    ///
    /// ```rust,no_run
    /// use zen_protocol::transport::WebSocketTransport;
    /// use std::collections::HashMap;
    ///
    /// #[tokio::main]
    /// async fn main() -> anyhow::Result<()> {
