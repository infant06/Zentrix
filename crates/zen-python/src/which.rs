...
impl From<SpeechLoaderType> for zen_core::SpeechLoaderType {
    fn from(value: SpeechLoaderType) -> Self {
        match value {
            SpeechLoaderType::Dia => zen_core::SpeechLoaderType::Dia,
        }
    }
}
...
impl From<IsqOrganization> for zen_core::IsqOrganization {
    fn from(value: IsqOrganization) -> Self {
        match value {
            IsqOrganization::Default => zen_core::IsqOrganization::Default,
            IsqOrganization::MoQE => zen_core::IsqOrganization::MoeExpertsOnly,
        }
    }
}
